  ...
  return (
    <Overlay className={props.plainForm ? "plain" : "popup"}>
      <Page className={`${props.plainForm ? "plain" : "popup"} ${props.customClass ? props.customClass : ""}`}>
        ...
        {props.header ? <Header className={props.plainForm ? "plain" : "popup"} dangerouslySetInnerHTML={{ __html: props.header }}></Header> : ""}
                          ...
                          {multiple.map((subItem, childIndex) => {
                            return (
                              <FormInput
                                ...
                                key={`input` + childIndex}
                                sub={{ index, multipleIndex }}
                                id={childIndex}
        ...
        <Footer className={props.buttonStyle ? props.buttonStyle : "center"}>
          ...
          <FormInput disabled={submitDisabled} type="submit" name="submit" css="theme" value={t(props.button ? props.button : "submit")} onChange={submitChange} />
        </Footer>
      </Page>
    </Overlay>
  );
