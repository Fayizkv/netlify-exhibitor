    ...
    <PaginationContainer>
      <PaginationInfo>
        {isMobile ? (
          ...
          <>
            {totalRows} Records • <span>Page </span>
            {currentPage} of {totalPages}
          </>
        )}
      </PaginationInfo>
      ...
      <RowsPerPage>
        {rowsPerPage && <Select align="auto" value={rowsPerPage} label="" defaultValue={rowsPerPage} onSelect={(value) => handleRowsPerPageChange(value)} selectApi={rowsPerPageOptions} />}
      </RowsPerPage>
    </PaginationContainer>
  );
};
