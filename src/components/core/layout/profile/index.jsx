        ...
        <div className="p-4 space-y-3">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-bg-soft/40">
            ...
            <div>
              ...
              <p className="text-sm text-text-main">{user?.emailId ?? user?.email ?? "No Email"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl bg-bg-soft/40">
            ...
            <div>
              ...
              <p className="text-sm text-text-main capitalize">{user?.userType ?? user?.userType?.role ?? "Exhibitor"}</p>
            </div>
          </div>
