...
const EditorNew = (props) => {
  ...
  // Expose the insertTextAtCursor method to parent components
  useEffect(() => {
    if (props.onEditorReady) {
      props.onEditorReady(editorRef);
    }
  }, [editorRef, props.onEditorReady]);
    ...
    >
      <EditorWrapper className={showEditor ? "fullscreen" : ""}>
        ...
        <EditorContent className={showEditor ? "fullscreen" : ""}>
          ...
          <TiptapEditor value={editorValue} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur} fullScreen={showEditor} placeholder={props.placeholder} onEditorReady={setEditorRef} />
