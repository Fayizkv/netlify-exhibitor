...
export const Input = styled.input`
  ...
  &:-webkit-autofill:active {
    -webkit-box-shadow: 0 0 0 1000px ${appTheme.bg.white} inset !important;
    -webkit-text-fill-color: ${appTheme.text.main} !important;
    box-shadow: none !important;
    border: 0 !important;
    transition: background-color 5000s ease-in-out 0s;
    caret-color: ${appTheme.text.main};
  }

  /* Autofill focus state - Match the focus styling */
  &:-webkit-autofill:focus {
    border: 0 !important;
    box-shadow: none !important;
  }
...
export const TextArea = styled.textarea`
  ...
  &:-webkit-autofill:active {
    -webkit-box-shadow: 0 0 0 1000px ${appTheme.bg.white} inset !important;
    -webkit-text-fill-color: ${appTheme.text.main} !important;
    box-shadow: 0 0 0 1000px ${appTheme.bg.white} inset !important;
    border: 1px solid ${appTheme.stroke.soft} !important;
    transition: background-color 5000s ease-in-out 0s;
    caret-color: ${appTheme.text.main};
  }
  ...
  /* Autofill focus state - Match the focus styling */
  &:-webkit-autofill:focus {
    border: 1px solid ${appTheme.stroke.strong} !important;
    box-shadow: 0px 0px 0px 4px #e4e5e7, 0 0 0 1000px ${appTheme.bg.white} inset !important;
  }
`;
