...
const EventFormDemo = (props) => {
  //to update the page title
  useEffect(() => {
    document.title = `EventFormDemo - EventHex Portal`;
  }, []);
  ...
  useEffect(() => {
    getData({ event: props?.openData?.data?._id }, "ticket-form-data").then((response) => {
...
export default Layout(EventFormDemo);
