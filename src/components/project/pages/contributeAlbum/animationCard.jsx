...
export const GlareCard = ({ children, className }) => {
  ...
  return (
    ...
    >
      <div className="h-full  grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-xl hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden gap-4">
