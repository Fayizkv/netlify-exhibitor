...
const Model = (props) => {
  ...
  return (
    <Container className="noshadow">
      <ListTable api={`model`} actions={actions} itemTitle={{ name: "modelName", type: "text", collection: "" }} shortName={`Model`} formMode={`double`} {...props} attributes={attributes}></ListTable>
    </Container>
  );
};
