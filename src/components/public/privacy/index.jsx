  ...
  return (
    <div>
      <MainContainer>
        ...
        <Container>
          <p>
            Our parking system is committed to protecting the privacy of our users. This Privacy Policy explains the types of information we collect, how we use it, and the steps we take to ensure
            that it is protected.
          </p>
          <h2>Information Collection</h2>
          <p>
            We collect information from users in several ways, including when users register for an account, make a reservation, or contact customer support. This information may include name, email
            address, phone number, and payment information.
          </p>
          <h2>Use of Information</h2>
          <p>
            We use the information we collect to provide and improve our services, to communicate with users, and to resolve any issues that may arise. We may also use the information for marketing
            purposes, but only with the user's consent.
          </p>
