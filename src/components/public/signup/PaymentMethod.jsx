  ...
  const paymentGateways = [
    ...
    // },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            d="M13.7071 10.5429C13.7071 9.74361 14.3578 9.09286 15.1571 9.09286H16.6071C17.4064 9.09286 18.0571 9.74361 18.0571 10.5429V11.9929C18.0571 12.7921 17.4064 13.4429 16.6071 13.4429H15.1571C14.3578 13.4429 13.7071 12.7921 13.7071 11.9929V10.5429Z"
            stroke="#64748B"
            strokeWidth="1.5"
          />
          <path
            d="M5.94287 10.5429C5.94287 9.74361 6.59362 9.09286 7.39287 9.09286H8.84287C9.64213 9.09286 10.2929 9.74361 10.2929 10.5429V11.9929C10.2929 12.7921 9.64213 13.4429 8.84287 13.4429H7.39287C6.59362 13.4429 5.94287 12.7921 5.94287 11.9929V10.5429Z"
            stroke="#64748B"
            strokeWidth="1.5"
          />
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M17.9982 9.0398H15.7266C15.6301 9.0398 15.5463 9.11426 15.5321 9.20941L14.7867 14.2931C14.7672 14.4283 14.8711 14.5506 15.0081 14.5506H16.1057C16.2022 14.5506 16.286 14.4761 16.3002 14.381L16.5041 13.0647C16.5183 12.9696 16.6021 12.8951 16.6986 12.8951H17.5632C19.4589 12.8951 20.5772 11.9397 20.8678 10.1229C20.9929 9.35805 20.8322 8.74611 20.4451 8.32672C20.0097 7.85614 19.1967 7.66583 17.9982 7.66583V9.0398Z"
            stroke="#64748B"
            strokeWidth="1.5"
            strokeMiterlimit="10"
          />
          <path
            d="M3.13184 9.0398H5.40341C5.49993 9.0398 5.58372 9.11426 5.59791 9.20941L6.34332 14.2931C6.36281 14.4283 6.25899 14.5506 6.12194 14.5506H4.81473C4.71821 14.5506 4.63442 14.4761 4.62023 14.381L4.41634 13.0647C4.40215 12.9696 4.31835 12.8951 4.22184 12.8951H3.35723C1.46156 12.8951 0.343262 11.9397 0.0526674 10.1229C-0.0724054 9.35805 0.088311 8.74611 0.475397 8.32672C0.910809 7.85614 1.72382 7.66583 2.92229 7.66583L3.13184 9.0398Z"
            stroke="#64748B"
            strokeWidth="1.5"
            strokeMiterlimit="10"
          />
        ...
        {paymentGateways.map((gateway) => (
          <div
            ...
            className={`relative p-4 rounded-lg border transition-colors cursor-pointer
              ...
              ${selectedGateway === gateway.id && gateway.isEnabled ? "border-primary-base bg-primary-soft" : "border-stroke-soft"}`}
          >
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                ${selectedGateway === gateway.id && gateway.isEnabled ? "border-primary-base" : "border-stroke-base"}`}
              >
                {selectedGateway === gateway.id && gateway.isEnabled && <div className="w-2.5 h-2.5 rounded-full bg-primary-base"></div>}
              </div>
            </div>

            {/* Coming Soon Badge */}
            {!gateway.isEnabled && <span className="absolute top-2 right-2 text-xs bg-background-base text-text-soft px-2 py-1 rounded-full">Coming Soon</span>}
          </div>
        ))}
      </div>
    </div>
